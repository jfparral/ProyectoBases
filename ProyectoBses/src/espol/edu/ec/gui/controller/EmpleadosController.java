...
public class EmpleadosController implements Initializable {
    ...
    @FXML
    private TextField txtModificarDireccion;
    ...
    public void agregarEmpleado(ActionEvent event) {
        validarCampos();
           try{
            ...
            ps=con.prepareStatement("INSERT INTO trabajador VALUES('"+txtModifcarCedula.getText()+"', '"+txtModifcarNombre.getText()+"', '"+txtModifcarApellido.getText()+"', '"+dateModificarEmpleado.getValue().toString()+"', '"+choSexoModificarEmpleado.getValue()+"', '"+txtModifcarTelefono.getText()+"', '"+txtModificarDireccion.getText()+","+txtModifcarCorreo.getText()+");");
